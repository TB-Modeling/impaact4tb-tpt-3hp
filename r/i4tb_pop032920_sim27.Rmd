...
time=11 #(2020~2030)
imp.time=27 #3HP effectiveness time =10years
...
write.table(as.matrix(rowSums(m )), "C:/Users/julia shin/Documents/JHU/I4TB/modeling/HIVdiag27.txt", sep="\t") 
...
write.table(m.ART, "C:/Users/julia shin/Documents/JHU/I4TB/modeling/HIVonART27.txt", sep="\t")  
...
write.table(table.m.TPT, "C:/Users/julia shin/Documents/JHU/I4TB/modeling/TPT(status quo)27.txt", sep="\t")  
...
write.table((m.p3HP.S1), "C:/Users/julia shin/Documents/JHU/I4TB/modeling/3HP27.txt", sep="\t")         
...
write.table(as.matrix(m.new), "C:/Users/julia shin/Documents/JHU/I4TB/modeling/new_pop27 .txt", sep="\t") 
``` 
...
write.table(m.S1.oldART, "C:/Users/julia shin/Documents/JHU/I4TB/modeling/old_pop27.txt", sep="\t") 


m.S1 <- m.new + m.old 
write.table(m.S1, "C:/Users/julia shin/Documents/JHU/I4TB/modeling/S1.catpop27.txt", sep="\t") 
...
write.table(as.matrix(colSums(Delivery.sum.i4tb)), "C:/Users/julia shin/Documents/JHU/I4TB/modeling/cost.i4tb27.txt", sep="\t") 
...
write.table(as.matrix(colSums(Tox.sum.i4tb)), "C:/Users/julia shin/Documents/JHU/I4TB/modeling/toxcost.i4tb27.txt", sep="\t") 
...
write.table(as.matrix(colSums(TBcostsaved.sum.i4tb)), "C:/Users/julia shin/Documents/JHU/I4TB/modeling/TBcostsaved.i4tb27.txt", sep="\t") 
...
write.table(as.matrix(colSums(ARTcost.sum.i4tb)), "C:/Users/julia shin/Documents/JHU/I4TB/modeling/ARTcost.i4tb27.txt", sep="\t") 
...
write.table(table.I4TB, "C:/Users/julia shin/Documents/JHU/I4TB/modeling/table.I4TB27.txt", sep="\t") 
...
write.table(calendar1.I4TB, "C:/Users/julia shin/Documents/JHU/I4TB/modeling/calendar1.I4TB27.txt", sep="\t") 
write.table(calendar2.I4TB, "C:/Users/julia shin/Documents/JHU/I4TB/modeling/calendar2.I4TB27.txt", sep="\t") 
...
write.csv(sim.out, "C:/Users/julia shin/Documents/JHU/I4TB/modeling/topdown.sim27.csv") 
write.csv(ICER, "C:/Users/julia shin/Documents/JHU/I4TB/modeling/icer.topdown.sim27.csv")
...
write.table(as.matrix(colSums(Delivery1.sum.S1)), "C:/Users/julia shin/Documents/JHU/I4TB/modeling/costs1.S127.txt", sep="\t") 
...
write.table(as.matrix(colSums(Delivery2.sum.S1)), "C:/Users/julia shin/Documents/JHU/I4TB/modeling/costs2.S127.txt", sep="\t") 
...
write.table(as.matrix(colSums(Tox.sum.S1)), "C:/Users/julia shin/Documents/JHU/I4TB/modeling/toxcost.S127.txt", sep="\t") 
...
write.table(as.matrix(colSums(TBcostsaved.sum.S1)), "C:/Users/julia shin/Documents/JHU/I4TB/modeling/TBcostsaved.S127.txt", sep="\t")
...
write.table(as.matrix(colSums(ARTcost.sum.S1)), "C:/Users/julia shin/Documents/JHU/I4TB/modeling/ARTcost.S127.txt", sep="\t") 
...
write.table(table.S1, "C:/Users/julia shin/Documents/JHU/I4TB/modeling/table.S127.txt", sep="\t") 
...
write.table(table2.S1, "C:/Users/julia shin/Documents/JHU/I4TB/modeling/table2.S127.txt", sep="\t") 
...
write.table(table.S1.plus, "C:/Users/julia shin/Documents/JHU/I4TB/modeling/table.S1.plus27.txt", sep="\t") 
...
write.table(calendar1.S1, "C:/Users/julia shin/Documents/JHU/I4TB/modeling/calendar1.S127 .txt", sep="\t") 
write.table(calendar2.S1 , "C:/Users/julia shin/Documents/JHU/I4TB/modeling/calendar2.S127 .txt", sep="\t") 
...
write.csv(sim.S1.out, "C:/Users/julia shin/Documents/JHU/I4TB/modeling/S1.sim27.csv") 
...
write.csv(ICER.S1, "C:/Users/julia shin/Documents/JHU/I4TB/modeling/icer.S1.sim27.csv")
...
write.csv(I4TBS1.sim , "C:/Users/julia shin/Documents/JHU/I4TB/modeling/I4TBS1.sim27.csv")  
...
write.csv(ICER.final.SA, "C:/Users/julia shin/Documents/JHU/I4TB/modeling/icer.final.sim27.csv")
